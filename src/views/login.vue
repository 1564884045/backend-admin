    ...
    <div>
        ...
        <div id="login-box">
            <div class="login-banner">
                <svg-icon style="width: 90%;height: 100%;" slot="prefix" name="login-icon"/>
            </div>
...
<!--                    <el-button type="danger" size="mini" plain @click="testAccount('admin')">admin</el-button>-->
<!--                </div>-->
            </el-form>
        </div>
...
export default {
    ...
    data() {
        return {
            title: this.$setting.title,//process.env.VUE_APP_TITLE,
            form: {
