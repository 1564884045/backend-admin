...
import confRouter from "@/router/modules/ConfRouter";
import UIRouter from "@/router/modules/UIRouter";

import UserRouter from "@/router/modules/UserRouter";
import SelectsRouter from "@/router/modules/SelectsRouter";
import TeacherRouter from "@/router/modules/edu/TeacherRouter";
import JiGouRouter from "@/router/modules/edu/JiGouRouter";
import StudentsRouter from "@/router/modules/edu/StudentsRouter";
import VipRouter from "@/router/modules/VipRouter";
import ArticleRouter from "@/router/modules/ArticleRouter";
import CircleRouter from "@/router/modules/edu/CircleRouter";
import AppointRouter from "@/router/modules/message/AppointRouter";
import ChatListRouter from "@/router/modules/message/ChatListRouter";
...
router.beforeEach(async (to, from, next) => {
    ...
    // 已经登录，但还没根据权限动态挂载路由
    if (store.getters['user/hasLogin'] && !store.state.menu.isGenerate) {
        /**
         * 重置 matcher
    ...
    if (store.state.menu.isGenerate) {
        store.commit('menu/setHeaderNav', to.path)
    }
